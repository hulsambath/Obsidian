...
import 'package:vendor_app/constants/config_constants.dart';
import 'package:vendor_app/theme/m3/m3_color.dart';
import 'package:vendor_app/theme/theme_constant.dart';
  ...
  ThemeData get themeData {
    ...
    final themeData = ThemeData(
      ...
      floatingActionButtonTheme: FloatingActionButtonThemeData(
        ...
        extendedPadding: const EdgeInsets.symmetric(horizontal: ConfigConstants.margin2 + 4),
      ),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: ConfigConstants.circlarRadius1,
        ),
      ),
